...
export class Terminal {
  ...
  help() {
    ...
    this.terminalPrint('');
    this.terminalPrint('POKE VAULT:');
    this.terminalPrint('  pokevault  - Start or view Poke Vault protocol status');
    this.terminalPrint('  shards     - View recovered shard fragments');
    this.terminalPrint('  assemble   - Verify reconstructed secret');
    this.terminalPrint('  pokevaultreset - Reset Poke Vault progress');
    this.terminalPrint('');
